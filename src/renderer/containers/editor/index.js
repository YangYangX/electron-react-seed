...
class Editor extends Component {
  ...
  ProjectMenu = () => (
    <Menu>
      ...
      <MenuItem icon="build" text="构建" />
      <MenuItem icon="folder-close" text="生成Java项目" />
      <MenuDivider title="导出" />
      <MenuItem icon="document" text="json文件" />
  ...
  SystemMenu = () => (
    <Menu>
      ...
      <MenuItem icon="help" text="帮助" />
      <MenuItem icon="link" text="访问网站" />
      <MenuItem icon="error" text="报告错误" />
      <MenuDivider />
      <MenuItem icon="refresh" text="检查更新" />
      <MenuItem
        icon="info-sign"
        text="关于"
        onClick={() => {
            ...
            <Grid.Column width={13} style={Styles.mainSection}>
              <Grid>
                ...
                <Grid.Row style={Styles.workAreaDesc}>
                  <Grid.Column width={16} style={Styles.consoleContainer}>
